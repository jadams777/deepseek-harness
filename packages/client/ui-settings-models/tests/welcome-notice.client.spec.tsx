...
describe('WelcomeNotice', () => {
  it('uses the exact owner copy in both GUI locales', () => {
    expect(WELCOME_NOTICE_COPY.en).toEqual({
      ...
      body: "Keli 0.1 remains in testing. Many areas need further improvement, and we welcome your feedback. Keli's core plugins and foundational APIs will continue to evolve rapidly over the coming months.\n\nWe look forward to exploring the limits of intelligence with you, building on open-source, open, reusable, and composable infrastructure. Welcome to the Keli plugin ecosystem.",
