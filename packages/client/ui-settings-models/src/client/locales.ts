...
export const en = {
  ...
  welcomeBody: "Keli 0.1 remains in testing. Many areas need further improvement, and we welcome your feedback. Keli's core plugins and foundational APIs will continue to evolve rapidly over the coming months.\n\nWe look forward to exploring the limits of intelligence with you, building on open-source, open, reusable, and composable infrastructure. Welcome to the Keli plugin ecosystem.",
  welcomeContinue: 'Continue',
  welcomeError: 'The acknowledgement could not be saved. Please try again.',
  onboardingTitle: 'Add an API key to get started',
  onboardingDescription: 'Configure the OpenRouter provider to start building.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  creating: '创建中\u2026',
  welcomeTitle: '内测声明',
  welcomeBody: 'Keli 目前的 0.1 版本仍处在面向开发者进行测试的阶段，还有许多地方需要持续改进和打磨，希望听取大家的反馈建议。预计 Keli 的核心插件以及基础 API 都会在接下来的一段时间内快速迭代、持续演化。\n\n我们期待与你一起，在开源、开放、可复用、可组合的基础设施之上，共同探索智能上限。欢迎加入 Keli 插件生态。',
  welcomeContinue: '继续',
  welcomeError: '暂时无法保存确认状态，请重试。',
  onboardingTitle: '添加一个 API Key 开始使用',
  onboardingDescription: '配置 OpenRouter 模型，即可开始使用。',
